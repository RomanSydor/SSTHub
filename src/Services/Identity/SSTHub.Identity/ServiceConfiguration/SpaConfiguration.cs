...
namespace SSTHub.Identity.ServiceConfiguration
{
    public static class SpaConfiguration
    {
        ...
        public static void UseSpa(this IApplicationBuilder app, IWebHostEnvironment hostingEnvironment)
        {
            app.UseSpa(spa =>
            {
                spa.Options.SourcePath = "ClientApp/sst-hub-identity";
        ...
        public static void RunSpa(this IApplicationBuilder app, IWebHostEnvironment hostingEnvironment)
        {
            app.Run(async (context) =>
            {
                ...
                string indexFile = System.IO.Path.Combine(hostingEnvironment.ContentRootPath, "ClientApp", "sst-hub-identity", "build", "index.html");
